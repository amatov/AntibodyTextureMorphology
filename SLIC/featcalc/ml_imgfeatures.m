...
%
features = regionprops(double(im2bw(imageproc)), 'EulerNumber') ; % REMOVED IMFEATURE
...
%
[img_moment00, img_moment10, img_moment01, obj_size] = ml_moments_1(int32(imageproc),... % CHANGED INT32 to INT64
								     int32(imagelabeled));
